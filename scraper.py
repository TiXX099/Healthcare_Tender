...
def fetch_official_saudi_tenders_google():
    ...
    query = '("مناقصة" OR "منافسة" OR "شراء مباشر" OR "توريد" OR "كراسة شروط") AND ("مختبر" OR "أجهزة طبية" OR "مستلزمات" OR "مستشفى") (site:gov.sa OR site:health.sa OR site:moh.gov.sa OR site:etimad.sa OR site:nupco.com)'
